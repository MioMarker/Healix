...
function renderSubscriptionCard() {
  ...
  if (premium) {
    ...
    html += '<p style="font-size:12px;color:var(--cream-dim);line-height:1.6;margin-bottom:16px">Upgrade to Healix Pro for unlimited AI health chat. $9.99/month or $59.99/year, with a 1-week free trial.</p>';
